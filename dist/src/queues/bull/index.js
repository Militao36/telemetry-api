...
exports.queueAbacatePay = exports.queueLogs = exports.queueTraces = void 0;
...
const abacactePay_1 = require("./queues/abacactePay");
const REDIS_CONFIG = {
...
exports.queueAbacatePay = new bull_1.default('abacatepay', {
    redis: REDIS_CONFIG,
});
...
const abacatePayJobbProcessor = new abacactePay_1.AbacatePayJobbProcessor();
exports.queueAbacatePay.process(abacatePayJobbProcessor.handle.bind(abacatePayJobbProcessor));
